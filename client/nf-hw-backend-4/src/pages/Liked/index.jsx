...
export const Liked = () => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:5000/api/v5/playlist/666f4081629ea59782fb1cda`)
      .then(response => {
        setPlaylist(response.data);
      })
      .catch(error => console.error("Error fetching playlist", error));

    axios.get(`http://localhost:5000/api/v5/songs/playlists/666f4081629ea59782fb1cda`)
  ...
  const addSongToPlaylist = (songId, playlists) => {
    playlists.push('666f4081629ea59782fb1cda');
